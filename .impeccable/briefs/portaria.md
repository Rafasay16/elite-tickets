...
- **Primary User:** Venue Gatekeeper / Security Staff (`PORTARIA`, `ORGANIZER`, `SUPER_ADMIN`).
- **Context & Mental State:** Standing at turnstiles/doors in noisy, variable lighting, high-pressure queue situations where speed and zero false admissions are paramount.
